...
To protect the HV system in case of a short, we are using the Littelfuse L50QS150.V, a DC-rated 150A High-Speed fuse capable of breaking 50kA. Per regulations, we have one in each battery enclosure. Our HV system uses 2 AWG wire rated up to 105℃, resulting in a theoretical maximum current capacity of 215A. With a current limit set at 110A, a 150A fuse meets all fusing requirements.
