...
\caption{Exploded view of retention plate}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{figures/} %<-- UPDATE
...
\section{Crush Zone}
MSXII has been designed with an extruded polystyrene foam (EPS) crush zone, designed to absorb the energy of a 5G impact to the doors on both sides of the vehicle. The EPS crush foam is enclosed between the outer door panel and the inner door frame, made of 6061-T6 aluminum tubing, and the inner door panel. EPS foam does not shatter under loading, ensuring no fragments enter the driver cell in the event of a collision. 

% DEVON PUT A PICTURE HERE PLS :)
